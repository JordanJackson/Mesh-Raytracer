	...
	const uint32_t &frame)
{
	...
	//Vec3f origin;
	//options.cameraToWorld.MultPointVec(Vec3f(0), origin);
	...
	//		dir.Normalize();
	//		*(pix++) = CastRay(origin, dir, objects, options);
	//	}
	...
	//char buff[256];
	//sprintf_s(buff, "out.%04d.ppm", frame);
	//std::ofstream ofs;
	//ofs.open(buff);
